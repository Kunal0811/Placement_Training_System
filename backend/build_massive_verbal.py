...
def generate_prompt(difficulty: str) -> str:
    ...
    CRITICAL INSTRUCTIONS FOR VERBAL TYPES:
    You MUST include a mix of the following types:
    1. Reading Comprehension: Provide a paragraph (8-10 sentences) followed by a question based on it. Format it all inside the "question" field like this: "Passage: [text] \\n\\n Question: [text]"
    2. Para-jumbles (Sentence Ordering): Provide 4 jumbled sentences labeled P, Q, R, S and ask for the correct logical order. 
    3. Error Spotting / Sentence Correction.
    4. Logical Deduction / Statement & Assumption.
    5. Advanced Vocabulary (Synonyms/Antonyms/Idioms).
    ...
    6. If you need a new line inside a question (like for a paragraph), use the literal characters \\n.
    ...
    [
      {{
        "module": "{MODULE_NAME}",
        "topic": "Specific Sub-topic (e.g. Reading Comprehension, Para-jumbles, Error Spotting)",
        "difficulty": "{difficulty}",
        "question": "Passage: The quick brown fox jumps over the lazy dog. It was a sunny day. \\n\\n What was the weather like?",
...
async def main():
    ...
    # 20% Easy, 30% Medium, 50% Hard runs
    runs = ["easy", "easy", "medium", "medium", "medium", "hard", "hard", "hard", "hard", "hard"]
    
    print(f"🚀 Starting {MODULE_NAME} Miner with RC & Para-jumbles Support...")
    while True:
        for diff in runs:
