    ...
    <div className="min-h-screen bg-game-bg p-6 md:p-12">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mt-16 text-center">
            <Link to={`/aptitude/test/${encodeURIComponent("Final Aptitude Test")}/hard`} className="inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-red-600 to-pink-600 text-white font-bold rounded-2xl shadow-lg hover:shadow-red-500/40 hover:scale-105 transition-all">
